...
if [[ "$OSTYPE" == "darwin"* ]]; then
  VALID_ARGS=$(getopt -o h --l help,bindir:,maximum-memory:,libs-only,enable-libopus,libopus-prefix:,enable-libdav1d,libdav1d-prefix:,enable-libaom,libaom-prefix:,enable-libx264,libx264-prefix:,enable-libxml2,libxml2-prefix:,enable-openssl,openssl-prefix:,enable-libvpx,libvpx-prefix:,sudo: -- "$@")
else
